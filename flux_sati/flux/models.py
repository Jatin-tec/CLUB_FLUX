...
class Projects(models.Model):
    ...
    image2 = models.ImageField(upload_to='media', blank=True, null=True, default=False)
    image3 = models.ImageField(upload_to='media', blank=True, null=True, default=False)
